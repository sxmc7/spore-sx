...
public class Organoid extends UtilityEntity implements Enemy {
    ...
    public boolean hurt(DamageSource source, float p_21017_) {
        ...
        if (!com.Harbinger.Spore.Sentities.anticheat.DamageLimiter.isRegistered(this)) {
            ...
            com.Harbinger.Spore.Sentities.anticheat.DamageLimiter.setDamageCap(this, (float)(getMaxHealth() / 100.0));
        }
        
        float limitedAmount = com.Harbinger.Spore.Sentities.anticheat.DamageLimiter.limitDamage(this, source, p_21017_);
    ...
    public void regulateSpawns(){
        ...
        List<Entity> entityList = level().getEntities(this,aabb, this::isRegulableOrganoid);
    ...
    /**
     * 判断实体是否为可参与数量调控的 Organoid（排除 Proto 和 Mound）。
     */
    private boolean isRegulableOrganoid(Entity entity) {
        return entity instanceof Organoid && !(entity instanceof Proto || entity instanceof Mound);
    }
}
