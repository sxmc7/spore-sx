...
public class Lacerator extends Experiment {
    ...
    public boolean doHurtTarget(Entity entity) {
        ...
        if (flag && entity instanceof LivingEntity target && SConfig.SERVER.lacerator_force_remove.get()) {
            float reduction = SConfig.SERVER.lacerator_health_reduction.get().floatValue();
