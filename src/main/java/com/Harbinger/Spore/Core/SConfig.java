...
public class SConfig {
    ...
    public static class Server {
        ...
        // 百分比伤害配置 - 来自omnimobs技术
        public final ForgeConfigSpec.ConfigValue<Boolean> enable_percentage_damage;
        public final ForgeConfigSpec.ConfigValue<Double> default_percentage_damage;
        public final ForgeConfigSpec.ConfigValue<Double> evolved_percentage_damage;
        public final ForgeConfigSpec.ConfigValue<Double> hyper_percentage_damage;
        public final ForgeConfigSpec.ConfigValue<Double> calamity_percentage_damage;
        public final ForgeConfigSpec.ConfigValue<Boolean> bypass_armor;
        public final ForgeConfigSpec.ConfigValue<Boolean> bypass_creative;

        // 限伤系统配置 - 来自omnimobs技术
        public final ForgeConfigSpec.ConfigValue<Boolean> enable_damage_limit;
        public final ForgeConfigSpec.ConfigValue<Double> default_damage_limit;
        public final ForgeConfigSpec.ConfigValue<Double> boss_damage_limit;
        public final ForgeConfigSpec.ConfigValue<Integer> damage_limit_reset_frequency;
        public final ForgeConfigSpec.ConfigValue<Boolean> enable_damage_limit_anticheat;
        
        // 真菌武器破限伤配置
        public final ForgeConfigSpec.ConfigValue<Boolean> enable_weapon_bypass_damage_limit;
        
        // 改血攻击配置 - 破限伤能力
        public final ForgeConfigSpec.ConfigValue<Boolean> enable_force_set_health;
        public final ForgeConfigSpec.ConfigValue<Double> force_health_reduction;

        // 极寒附魔配置
        public final ForgeConfigSpec.ConfigValue<Double> extreme_frost_true_damage_percent;
        public final ForgeConfigSpec.ConfigValue<Integer> extreme_frost_freeze_ticks;
        public final ForgeConfigSpec.ConfigValue<Integer> extreme_frost_antiheal_ticks;
        public final ForgeConfigSpec.ConfigValue<Boolean> extreme_frost_shield_immune;
        public final ForgeConfigSpec.ConfigValue<Boolean> extreme_frost_aoe_immune;

        // AOE 真伤系统配置（Boss AOE 增强）
        public final ForgeConfigSpec.ConfigValue<Boolean> enable_aoe_true_damage;
        public final ForgeConfigSpec.ConfigValue<Double> aoe_true_damage_percent;
        public final ForgeConfigSpec.ConfigValue<Double> aoe_true_damage_flat;
        public final ForgeConfigSpec.ConfigValue<Double> aoe_max_health_zero_chance;
        
        // 撕裂变种强制清除配置
        public final ForgeConfigSpec.ConfigValue<Boolean> evolved_force_remove;
        public final ForgeConfigSpec.ConfigValue<Double> evolved_health_reduction;
        public final ForgeConfigSpec.ConfigValue<Boolean> hyper_force_remove;
        public final ForgeConfigSpec.ConfigValue<Boolean> lacerator_force_remove;
        public final ForgeConfigSpec.ConfigValue<Double> lacerator_health_reduction;
        // 磨碎属性强制清除配置
        public final ForgeConfigSpec.ConfigValue<Boolean> grinding_force_remove;
        public final ForgeConfigSpec.ConfigValue<Double> grinding_health_reduction;
        ...
        public final ForgeConfigSpec.ConfigValue<Double> grober_hp;
        public final ForgeConfigSpec.ConfigValue<Double> grober_damage;
        public final ForgeConfigSpec.ConfigValue<Double> grober_armor;
        ...
        public final ForgeConfigSpec.ConfigValue<Double> graken_hp;
        public final ForgeConfigSpec.ConfigValue<Double> graken_damage;
        public final ForgeConfigSpec.ConfigValue<Double> graken_armor;
        public final ForgeConfigSpec.ConfigValue<Double> graken_dpsr;
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> graken_buffs;
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> graken_debuffs;
        ...
        public final ForgeConfigSpec.ConfigValue<Double> conductor_armor;
        public final ForgeConfigSpec.ConfigValue<Double> conductor_hp;
        public final ForgeConfigSpec.ConfigValue<Double> conductor_damage;
        public final ForgeConfigSpec.ConfigValue<Double> conductor_el_small_damage;
        public final ForgeConfigSpec.ConfigValue<Double> conductor_el_discharge_damage;
        ...
        public Server(ForgeConfigSpec.Builder builder) {
            builder.push("生成与消失系统 / Despawning System");
            this.max_infected_cap = builder.define("普通感染生物最大数量 / Maximum number of regular infected",60);
            this.max_evolved_cap = builder.define("进化感染生物最大数量 / Maximum number of evolved infected",35);
            this.max_hyper_cap = builder.define("超级进化感染生物最大数量 / Maximum number of hyper infected",20);
            this.max_organoid_cap = builder.define("器官生物最大数量 / Maximum number of organoids",40);
            this.max_scent_cap = builder.define("气味实体最大数量 / Maximum number of scents",30);
            this.despawn_blacklist = builder.defineList("不会被系统消失的生物 / Mobs that will not be despawned by the system",
            ...
            builder.pop();
            builder.push("模组兼容性 / Compatibilities");
            this.faw_target = builder.comment("默认true / Default true").define("是否兼容FAW模组? / Should there be a compatibility with FAW?",true);
            this.skulk_target = builder.comment("默认true / Default true").define("是否兼容Sculk Infection模组? / Should there be a compatibility with Sculk Infection?",true);
            builder.pop();
            builder.push("音乐系统 / Music System");
            this.time_song_trigger = builder.define("环境音乐开始播放前的等待时间(分钟) / Time before ambient songs start playing in minutes",7);
            this.menu_song = builder.comment("默认true / Default true").define("是否在Minecraft菜单播放音乐? / Should we play songs in the minecraft menu?",true);
            this.encounter_songs = builder.comment("默认true / Default true").define("是否在遇到特定实体时播放音乐? / Should we play songs in certain entity encounters?",true);
            this.ambient_song = builder.comment("默认true / Default true").define("是否在世界中播放环境音乐? / Should we play songs in the minecraft world?",true);
            this.disable_vanilla = builder.comment("默认true / Default true").define("关闭原版音乐? / Turn off Vanilla music?",true);
            this.disable_system = builder.comment("默认false / Default false").define("关闭音乐系统? / Turn off the system?",false);
            builder.pop();
            builder.push("破坏参数 / Griefing Parameters");
            this.calamity_bd = builder.define("灾难级生物的方块破坏硬度 / The block breaking hardness of calamities",5);
            this.hyper_bd = builder.define("超级进化生物的方块破坏硬度 / The block breaking hardness of hyper evolveds",3);
            this.experiment_bd = builder.define("实验体生物的方块破坏硬度 / The block breaking hardness of experiments",1);
            builder.pop();

            builder.push("全局变量 / Global Variables");
            this.proto_spawn_world_mod = builder.define("改变世界所需的原始主脑数量(原始世界修改器) / The amount of needed Proto Hiveminds for the world to change (Proto World Modifier)",3);
            this.global_damage = builder.define("全局伤害修正 / Global Damage Modifier",1.0);
            this.global_health = builder.define("全局生命值修正 / Global Health Modifier",1.0);
            this.global_armor = builder.define("全局护甲修正 / Global Armor Modifier",1.0);
            this.weaktocold = builder.comment("默认true / Default true").define("感染生物是否对寒冷脆弱? / Should the infected be weak to cold?",true);
            this.should_starve = builder.comment("默认true / Default true").define("感染生物是否会随时间饥饿? / Should the infected starve overtime?",true);
            this.costumes = builder.comment("默认true / Default true").define("某些生物是否偶尔穿着服装? / Should certain mobs wear costumes on occasions?",true);
            this.costumes_active = builder.comment("默认false / Default false").define("服装是否始终激活? / Should the costumes be always active?",false);
            this.higher_thinking = builder.comment("默认true / Default true").define("某些感染生物是否具有高级思维(如开门或破坏方块)? / Should some infected have higher thinking such as opening doors or trying to break certain blocks?",true);
            this.hunger = builder.define("饥饿时间(秒) / Hunger in seconds",300);
            this.teleport_hive = builder.comment("默认false / Default false").define("主脑形成后是否传送到地表? / Move the hivemind to the surface once it forms?",false);
            this.damagecap = builder.comment("默认true / Default true").define("进化和超级进化生物在困难模式下是否有伤害上限? / Should evolved and hyper have a damage cap on hard mode?",true);
            builder.pop();
            
            builder.push("百分比伤害系统 / Percentage Damage System");
            this.enable_percentage_damage = builder.comment("默认true / Default true. 启用omnimobs风格的百分比伤害系统 / Enable omnimobs-style percentage damage system").define("启用百分比伤害 / Enable percentage damage",true);
            this.default_percentage_damage = builder.comment("默认5.0 / Default 5.0. 普通感染生物的百分比伤害(目标最大生命值的5%) / Base percentage damage for infected (5% of target max health)").define("默认百分比伤害 / Default percentage damage",5.0);
            this.evolved_percentage_damage = builder.comment("默认10.0 / Default 10.0. 进化感染生物的百分比伤害(目标最大生命值的10%) / Percentage damage for evolved infected (10% of target max health)").define("进化百分比伤害 / Evolved percentage damage",10.0);
            this.hyper_percentage_damage = builder.comment("默认15.0 / Default 15.0. 超级进化的百分比伤害(目标最大生命值的15%) / Percentage damage for hyper evolved (15% of target max health)").define("超级进化百分比伤害 / Hyper percentage damage",15.0);
            this.calamity_percentage_damage = builder.comment("默认20.0 / Default 20.0. 灾难级的百分比伤害(目标最大生命值的20%) / Percentage damage for calamities (20% of target max health)").define("灾难级百分比伤害 / Calamity percentage damage",20.0);
            this.bypass_armor = builder.comment("默认true / Default true. 百分比伤害是否穿透护甲? / Should percentage damage bypass armor?").define("穿透护甲 / Bypass armor",true);
            this.bypass_creative = builder.comment("默认false / Default false. 百分比伤害是否穿透创造模式? / Should percentage damage bypass creative mode?").define("穿透创造模式 / Bypass creative",false);
            builder.pop();
            
            // 限伤系统配置 - 来自omnimobs技术
            builder.push("限伤系统 / Damage Limit System");
            this.enable_damage_limit = builder.comment("默认true / Default true. 启用每帧伤害上限系统(值越低生物越强) / Enable per-frame damage limit system").define("启用限伤系统 / Enable damage limit",true);
            this.default_damage_limit = builder.comment("默认1.5 / Default 1.5. 普通生物每帧最大承受伤害(越低越强) / Max damage per frame for normal mobs").define("默认限伤值 / Default damage limit",1.5);
            this.boss_damage_limit = builder.comment("默认3.0 / Default 3.0. Boss生物每帧最大承受伤害(越低越强) / Max damage per frame for boss mobs").define("Boss限伤值 / Boss damage limit",3.0);
            this.damage_limit_reset_frequency = builder.comment("默认1 / Default 1. 伤害历史重置频率(每N帧) / Damage history reset frequency (every N frames)").define("重置频率 / Reset frequency",1);
            this.enable_damage_limit_anticheat = builder.comment("默认true / Default true. 启用限伤系统反作弊保护 / Enable damage limit anti-cheat protection").define("启用反作弊保护 / Enable anti-cheat",true);
            
            // 真菌武器破限伤配置
            this.enable_weapon_bypass_damage_limit = builder.comment("默认true / Default true. 真菌武器是否无视非Boss限伤 / Should spore weapons bypass non-boss damage limit").define("武器破限伤 / Weapon bypass damage limit",true);
            
            // 改血攻击配置 - 破限伤能力
            this.enable_force_set_health = builder.comment("默认true / Default true. 启用改血攻击(破限伤能力，直接修改目标血量) / Enable force set health attack (breaks damage limit)").define("启用改血攻击 / Enable force set health",true);
            this.force_health_reduction = builder.comment("默认10.0 / Default 10.0. 改血攻击每次减少的血量 / Health reduction per force set health attack").define("改血攻击血量减少 / Force health reduction",10.0);
            
            // 撕裂变种强制清除配置
            this.evolved_force_remove = builder.comment("默认true / Default true. 进化感染是否启用强制清除(类似MetapotentFlashfur) / Enable evolved infected force remove (like MetapotentFlashfur)").define("进化感染强制清除 / Evolved force remove",true);
            this.evolved_health_reduction = builder.comment("默认15.0 / Default 15.0. 进化感染强制清除每次减少的血量 / Health reduction per evolved force remove").define("进化感染清除减血 / Evolved health reduction",15.0);
            this.hyper_force_remove = builder.comment("默认true / Default true. 超级进化是否启用强制清除(直接删除实体) / Enable hyper force remove (directly delete entity)").define("超级进化强制清除 / Hyper force remove",true);
            this.lacerator_force_remove = builder.comment("默认true / Default true. 实验体撕裂者是否启用强制清除 / Enable lacerator force remove").define("撕裂者强制清除 / Lacerator force remove",true);
            this.lacerator_health_reduction = builder.comment("默认20.0 / Default 20.0. 实验体撕裂者强制清除每次减少的血量 / Health reduction per lacerator force remove").define("撕裂者清除减血 / Lacerator health reduction",20.0);
            // 磨碎属性强制清除配置
            this.grinding_force_remove = builder.comment("默认true / Default true. 磨碎属性是否启用强制清除 / Enable grinding force remove").define("磨碎强制清除 / Grinding force remove",true);
            this.grinding_health_reduction = builder.comment("默认25.0 / Default 25.0. 磨碎强制清除每次减少的血量 / Health reduction per grinding force remove").define("磨碎清除减血 / Grinding health reduction",25.0);
            builder.pop();

            // 极寒附魔配置
            builder.push("极寒附魔 / ExtremeFrost");
            this.extreme_frost_true_damage_percent = builder.comment("默认0.5 / Default 0.5. 极寒附魔真伤百分比(目标最大血量的50%/级) / ExtremeFrost true damage percent per level (50% of target max HP)").define("真伤百分比 / True damage percent", 0.5);
            this.extreme_frost_freeze_ticks = builder.comment("默认20 / Default 20. 极寒附魔冻结时长(tick)/级 / ExtremeFrost freeze duration per level (tick)").define("冻结时长 / Freeze ticks", 20);
            this.extreme_frost_antiheal_ticks = builder.comment("默认200 / Default 200. 极寒附魔禁疗时长(tick)/级 / ExtremeFrost anti-heal duration per level (tick)").define("禁疗时长 / Anti-heal ticks", 200);
            this.extreme_frost_shield_immune = builder.comment("默认true / Default true. 极寒盾牌免疫 Spore 生物伤害 / ExtremeFrost shield grants immunity to Spore damage").define("盾牌免疫 / Shield immune", true);
            this.extreme_frost_aoe_immune = builder.comment("默认true / Default true. 极寒武器免疫 Spore AOE 伤害 / ExtremeFrost weapon grants immunity to Spore AOE damage").define("AOE免疫 / AOE immune", true);
            builder.pop();

            // AOE 真伤系统配置
            builder.push("AOE真伤 / AOE True Damage");
            this.enable_aoe_true_damage = builder.comment("默认true / Default true. 启用Boss AOE真伤系统(反射绕限伤) / Enable Boss AOE true damage system (reflection bypass)").define("启用AOE真伤 / Enable AOE true damage", true);
            this.aoe_true_damage_percent = builder.comment("默认0.02 / Default 0.02. AOE真伤百分比(目标最大血量的2%) / AOE true damage percent (2% of target max HP)").define("AOE真伤百分比 / AOE true damage percent", 0.02);
            this.aoe_true_damage_flat = builder.comment("默认1.0 / Default 1.0. AOE真伤固定值 / AOE true damage flat amount").define("AOE真伤固定值 / AOE true damage flat", 1.0);
            this.aoe_max_health_zero_chance = builder.comment("默认0.1 / Default 0.1. setMaxHealth(0)斩杀概率(每帧) / setMaxHealth(0) kill chance (per tick)").define("斩杀概率 / Kill chance", 0.1);
            builder.pop();

            builder.push("区块加载 / Chunk Loading");
            this.calamity_chunk = builder.comment("默认true / Default true").define("灾难级生物是否加载区块? / Should a calamity load chunks?",true);
            this.armor_blacklist = builder.defineList("Mobs to not render spore armor on",
                    Lists.newArrayList(
                            "minecraft:zombie") , o -> o instanceof String);
            builder.pop();
            builder.push("目标选择 / Targeting Tasks");
            this.at_mob = builder.comment("默认true / Default true").define("是否 / Should attack other mobs?",true);
            this.at_an = builder.comment("默认false / Default false").define("是否 / Should attack Animals?",false);
            ...
            builder.push("生物角色，决定感染生物间的互动 / Mob Roles");
            ...
            builder.push("生物进化与感染系统 / Mob Evolutions and Infection System");
            builder.push("进化 / Evolutions");
            ...
            this.inf_player = builder.comment("默认true / Default true").define("是否 / Should the player be infected on death?",true);
            ...
            this.wendigo_disarmor = builder.comment("默认true / Default true").define("是否 / Should the wendigo take off ur armor?",true);
            builder.pop();
            ...
            this.hohl_r_damage = builder.comment("Default 1").defineInRange("Sets Hohlfresser Ramged Damage", 1, 1, Double.MAX_VALUE);
            ...
            this.mound_foliage = builder.comment("默认true / Default true").define("是否 / Should the mound spread foliage and infect blocks?",true);
            builder.pop();
            ...
            this.proto_chunk = builder.comment("默认true / Default true").define("是否 / Should the hivemind generate a chunkloader at its location?",true);
            this.proto_raid = builder.comment("默认true / Default true").define("是否 / Should the hivemind send Vigils to raid?",true);
            this.proto_casing = builder.comment("默认true / Default true").define("是否 / Should the hivemind build a wall of flesh around itself?",true);
            this.proto_madness = builder.comment("默认true / Default true").define("是否 / Should the hivemind spread madness?",true);
            ...
            this.htumor_madness = builder.comment("默认true / Default true").define("是否 / Should the Hivetumor spread madness?",true);
            ...
            builder.push("Scent");
            this.scent_spawn = builder.comment("默认true / Default true").define("是否 / Should Scents spawn?",true);
            this.scent_particles = builder.comment("默认true / Default true").define("是否 / Should Scents have particles?",true);
            ...
            this.scent_summon = builder.comment("默认true / Default true").define("是否 / Should scent summon entities?",true);
            ...
            this.inf_van_potion = builder.comment("默认true / Default true").define("Can the Infected Wandering Trader use Potions", true);
            builder.pop();
            ...
            this.use_potions = builder.comment("默认true / Default true").define("是否 / Should Witches use Potions?",true);
            ...
            this.scamper_summon = builder.comment("默认true / Default true").define("是否 / Should Scampers summon Mounds on death?",true);
            builder.pop();
            ...
            this.tendril_chest = builder.comment("默认true / Default true").define("是否 / Should tendrils go to food containers ?",true);
            this.tendril_spawner = builder.comment("默认true / Default true").define("是否 / Should tendrils go to spawners ?",true);
            this.tendril_corpse = builder.comment("默认true / Default true").define("是否 / Should tendrils go to human remains ?",true);
            builder.pop();
            ...
            this.explosion_on = builder.comment("默认true / Default true").define("是否 / Should explosion break blocks ?",true);
            builder.pop();
            ...
            this.chemist_explosion_on = builder.comment("默认true / Default true").define("是否 / Should explosion break blocks ?",true);
            builder.pop();
            ...
            builder.push("生成 / Spawns");
            this.daytime_spawn = builder.comment("默认false / Default false").define("是否 / Should mobs be also able to spawn in daytime?",false);
    ...
    public static class DataGen{
        ...
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> naiad_loot;
        ...
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> grober_loot;
        ...
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> conductor_loot;
        ...
        public DataGen(ForgeConfigSpec.Builder builder){
            ...
            this.inf_braio_loot = builder.defineList("Braiomil",
                    Lists.newArrayList("spore:mutated_fiber|80|1|3","spore:armor_fragment|50|1|2","spore:fang|50|1|2","spore:claw_fragment|80|1|3","spore:mutated_heart|10|1|1","spore:alveolic_sack|40|1|3") , o -> o instanceof String);
            ...
            this.brot_loot = builder.defineList("Brotkatze",
                    Lists.newArrayList("spore:mutated_fiber|70|5|9","spore:fang|50|2|5","spore:armor_fragment|80|2|10","spore:mutated_heart|50|1|1","spore:claw_fragment|80|5|10","spore:alveolic_sack|80|2|4") , o -> o instanceof String);
            ...
            builder.pop();
            builder.push("结构数据 / Structure data");
            ...
            builder.pop();
            builder.push("方块感染 / Block infection");
            ...
            builder.pop();
            builder.push("低温机器参数 / Cryogenic machine parameters");
            ...
            this.cryo_snow = builder.comment("默认true / Default true").define("是否 / Should the CDU create snow?",true);
            builder.pop();
            builder.push("袭击系统参数 / Raid system parameters");
