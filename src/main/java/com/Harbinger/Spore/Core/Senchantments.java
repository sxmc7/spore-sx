...
public class Senchantments {
    ...
    // 极寒附魔 - 无视限伤、无敌帧，冻结Spore生物，无视AOE
    public static final RegistryObject<Enchantment> EXTREME_FROST = ENCHANTMENTS.register("extreme_frost", ExtremeFrostEnchantment::new);
